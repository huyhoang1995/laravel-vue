<template>
    <div class="row col-sm-12">
        ...
        <div>
            <button @click="disconnect()"> cancel call</button>
        </div>
    ...
    if(nameRoom){
        ...
        for (let i = 0; i < localTracks.length; i++) {
            ...
            if (localTracks[i].getType() === 'video') {
                $('.center-video').append(`<video autoplay='1' id='localVideo${i}' />`);
...
function onConnectionSuccess() {
    ...
    console.log(nameRoom,'get room name');
