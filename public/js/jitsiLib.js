! function(e, t) {
    ...
    return function(e) {
        ...
        function h(e) {
            ...
            let n, r, i;
            if (e = e.replace(/\s/g, ""), (r = (n = new RegExp(c, "gi")).exec(e)) && (t.protocol = r[1].toLowerCase(), e = e.substring(n.lastIndex)), r = (n = new RegExp(`^${o}`, "gi")).exec(e)) {
            ...
            if ((r = (n = new RegExp(`^${a}`, "gi")).exec(e)) && (i = r[1], e = e.substring(n.lastIndex)), i ? i.startsWith("/") || (i = `/${i}`) : i = "/", t.pathname = i, e.startsWith("?")) {
        ...
        function p(e) {
            let t;
            const n = h(u(t = e.serverURL && e.room ? new URL(e.room, e.serverURL).toString() : e.room ? e.room : e.url || ""));
            if (!n.protocol) {
            ...
            if (!n.host) {
                ...
                if (t) {
                    ...
                    e && (n.host = e, n.hostname = i, n.port = a), "/" === r && "/" !== o && (r = o)
                }
            }
        ...
        class x {
            ...
            _onMessageReceived(e) {
                ...
                } else e.type === L ? this.emit("request", e.data, (t, n) => {
                    this._backend.send({
                        type: O,
                        error: n,
                        id: e.id,
        ...
        const j = {};
        let C;
        "number" == typeof f && (j.scope = `jitsi_meet_external_api_${f}`), (window.JitsiMeetJS || (window.JitsiMeetJS = {}), window.JitsiMeetJS.app || (window.JitsiMeetJS.app = {}), window.JitsiMeetJS.app).setExternalTransportBackend = e => C.setBackend(e);
        var E = n(4),
            S = n(0);
        ...
        class $ extends i.a {
            constructor(e, ...t) {
                ...
                this._parentNode = s, this._url = M(e, {
                    configOverwrite: o,
                    interfaceConfigOverwrite: a,
                    jwt: u,
                    noSSL: c,
                    ...
                    devices: d,
                    userInfo: p
                }), this._createIFrame(i, r, l), this._transport = new x({
                    backend: new _({
                        postisOptions: {
                ...
                }), Array.isArray(h) && h.length > 0 && this.invite(h), this._isLargeVideoVisible = !0, this._numberOfParticipants = 0, this._participants = {}, this._myUserID = void 0, this._onStageParticipant = void 0, this._setupListeners(), A++
            }
            _createIFrame(e, t, n) {
            ...
            getAvailableDevices() {
                return Object(S.a)(this._transport)
            }
            getCurrentDevices() {
                return Object(S.b)(this._transport)
            }
            isAudioAvailable() {
            ...
            isDeviceChangeAvailable(e) {
                return Object(S.c)(this._transport, e)
            }
            isDeviceListAvailable() {
                return Object(S.d)(this._transport)
            }
            isMultipleAudioInputSupported() {
                return Object(S.e)(this._transport)
            }
            invite(e) {
            ...
            setAudioInputDevice(e, t) {
                return Object(S.f)(this._transport, e, t)
            }
            setAudioOutputDevice(e, t) {
                return Object(S.g)(this._transport, e, t)
            }
            setVideoInputDevice(e, t) {
                return Object(S.h)(this._transport, e, t)
            }
...
//# sourceMappingURL=external_api.min.map//# sourceMappingURL=external_api.min.map
